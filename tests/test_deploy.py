...
def test_deploy_instance_nodes_without_space_transformation(
    cli_runner: CliRunner, obj: Dict[str, Optional[str]], new_dataset: DataSet, client: CogniteClient
) -> None:
    test_name = "test_deploy_"
    external_id = str(uuid.uuid1())
...
def test_deploy_instance_edges_with_edge_type_transformation(
    cli_runner: CliRunner, obj: Dict[str, Optional[str]], new_dataset: DataSet, client: CogniteClient
) -> None:
    test_name = "test_deploy_"
    external_id = str(uuid.uuid1())
...
def test_deploy_instance_edges_with_view_transformation(
    cli_runner: CliRunner, obj: Dict[str, Optional[str]], new_dataset: DataSet, client: CogniteClient
) -> None:
    test_name = "test_deploy_"
    external_id = str(uuid.uuid1())
