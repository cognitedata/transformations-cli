...
from cognite.experimental.data_classes.transformations import TransformationList
...
@click.option("-i", "--interactive", is_flag=True, help="Display only 10 transformations at a time, then page through them.")
@click.pass_obj
